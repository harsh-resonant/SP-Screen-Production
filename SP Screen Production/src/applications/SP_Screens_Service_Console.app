...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>SP Screens Service Console</description>
    ...
    <label>SP Screens Service Console</label>
    <listPlacement>
        <location>full</location>
    </listPlacement>
    <listRefreshMethod>refreshList</listRefreshMethod>
    <logo>SharedDocuments/SP_Screens_Logo_small.png</logo>
    ...
    <workspaceMappings>
        <mapping>
            <fieldName>Work_Order__c</fieldName>
            <tab>ActionPlan__c</tab>
        </mapping>
        <mapping>
