...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Owner_Peter_Bruce</fullName>
        <description>Owner Peter Bruce</description>
        <field>OwnerId</field>
        <lookupValue>peter@spscreens.com.au</lookupValue>
        <lookupValueType>User</lookupValueType>
        <name>Owner Peter Bruce</name>
        <notifyAssignee>true</notifyAssignee>
        <operation>LookupValue</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        <fullName>Owner Peter Bruce</fullName>
        <actions>
            <name>Owner_Peter_Bruce</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
